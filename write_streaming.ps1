...
'@
[System.IO.File]::WriteAllText("C:\Users\hp\Downloads\CreatorOS\CreatorOS-main\frontend\features\command-center\components\CommandInput.tsx", $content, (New-Object System.Text.UTF8Encoding($false)))
Write-Host "CommandInput.tsx updated: real-time streaming enabled for non-pipeline requests; pipeline flow untouched." -ForegroundColor Green
