# CreatorOS - Auth showcase panel v3
# - the "playing" video preview now has a cinematic intro:
#   1) CreatorOS logo sting  2) big title card (the video topic)  3) rotating AI-tool highlights
#   then it loops, on both /login and /register
#
